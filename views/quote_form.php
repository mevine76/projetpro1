...
<section class="bg-desktop-quote d-none d-sm-block p-5 vh-100">
  <div class="container">
    <h1 class="display-2 fw-semibold text-white mt-4">La <span class="text-warning">rénovation</span> sublime chaque coin de votre espace</h1>
...
<section class="bg-mobile-quote d-sm-none py-5 px-3 vh-50">
  <div class="container">
    <h1 class="display-5 fw-semibold text-white">La <span class="text-warning">rénovation</span> sublime chaque coin de votre espace</h1>
